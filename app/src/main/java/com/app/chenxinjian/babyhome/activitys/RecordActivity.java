...
import com.app.chenxinjian.babyhome.videorecorder.CONSTANTS;
import com.app.chenxinjian.babyhome.videorecorder.CustomUtil;
import com.app.chenxinjian.babyhome.videorecorder.FFmpegFrameRecorder;
import com.app.chenxinjian.babyhome.videorecorder.Interfaces;
import com.app.chenxinjian.babyhome.videorecorder.RecorderParameters;
import com.app.chenxinjian.babyhome.videorecorder.RecorderThread;
import com.app.chenxinjian.babyhome.videorecorder.SavedFrames;
import com.app.chenxinjian.babyhome.videorecorder.Util;
import com.app.chenxinjian.babyhome.view.ProgressView;
...
public class RecordActivity extends BaseActivity implements View.OnClickListener, View.OnTouchListener, Interfaces.AddBitmapOverlayListener {
    ...
    private void initCameraLayout() {
        new AsyncTask<String, Integer, Boolean>() {
            ...
            protected void onPostExecute(Boolean result) {
                ...
                cameraView = new CameraView(RecordActivity.this, cameraDevice);
                ...
                topLayout.setOnTouchListener(RecordActivity.this);

                switchCameraIcon.setOnClickListener(RecordActivity.this);
    ...
    public class AsyncStopRecording extends AsyncTask<Void, Integer, Void> {
        ...
        private void getFirstCapture(byte[] data) {
            String captureBitmapPath = Util.createImagePath(RecordActivity.this);
        ...
        protected Void doInBackground(Void... params) {
            ...
            if (CONSTANTS.DO_YOU_WANT_WATER_MARK_ON_VIDEO) {
                publishProgress(50);
                File file = Util.createWatermarkFilePath(RecordActivity.this);
                ;
                try {
                    if (file != null && !file.exists()) {
                        Bitmap watermark = BitmapFactory.decodeResource(getResources(), R.mipmap.replace_it_with_your_watermark);
                ...
                finalOutputPath = Util.createFinalPath(RecordActivity.this);
                ...
                publishProgress(60);
                CustomUtil.addBitmapOverlayOnVideo(RecordActivity.this, strVideoPath, file.getAbsolutePath(), finalOutputPath);
    ...
    private void showCancellDialog() {
        Util.showDialog(RecordActivity.this, getResources().getString(R.string.alert), getResources().getString(R.string.discard_video_msg), 2, new Handler() {
            @Override
            public void dispatchMessage(Message msg) {
                if (msg.what == 1)
                    videoTheEnd(false);
    ...
    private void handleSurfaceChanged() {
        ...
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.FROYO) {
            cameraDevice.setDisplayOrientation(Util.determineDisplayOrientation(RecordActivity.this, defaultCameraId));
